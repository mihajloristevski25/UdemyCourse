...
public class Utilities {
    ...
    //Returns a char array containing every n-th char. When
    ...
    public String removePairs(String source){
        // if lenght is less than 2 there wont be any pairs
        ...
        // Add the final character because it's always safe
        sb.append(string[string.length - 1]);
        return sb.toString();
    }

    //perform a conversion based on some internal bussines rule
