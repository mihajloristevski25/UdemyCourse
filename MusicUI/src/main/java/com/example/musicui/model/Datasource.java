...
public class Datasource {
    ...
    public static final String CONNECTION_STRING = "jdbc:sqlite:C:\\Users\\Mihajlo\\Desktop\\UdemyCourse\\MusicUI\\" + DB_NAME;
   ...
   public boolean updateArtistName(int id, String newName){
        try {
            ...
            System.out.println("Query failed: Update failed" + e.getMessage());
            return false;
        }
   }
